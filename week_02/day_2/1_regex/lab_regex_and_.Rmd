...
# Yes the thought police are mentioned. How many times
```
...
```{r}
pattern <- "[Winston] Smith"

whole_text %>%
  str_replace_all(pattern, "Name_Redacted")

# Need to include Winston Smith in this pattern as well.
